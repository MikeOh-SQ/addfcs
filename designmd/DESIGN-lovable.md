...
version: alpha
name: Lovable
description: A warm parchment-toned builder interface with charcoal ink, Camera Plain display type, opacity-based neutrals, and soft inset-button depth that feels approachable rather than clinical.
