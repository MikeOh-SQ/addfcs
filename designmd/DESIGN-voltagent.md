...
version: alpha
name: VoltAgent
description: A carbon-black developer interface with emerald signal accents, warm charcoal borders, native system display typography, Inter body text, and restrained terminal-grade containment.
