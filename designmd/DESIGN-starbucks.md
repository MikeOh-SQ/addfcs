...
version: alpha
name: Starbucks
description: A warm retail-cafe interface built on cream and ceramic canvases, anchored by Starbucks green, soft gold rewards accents, full-pill buttons, and calm rounded cards with restrained lift.
...
components:
  ...
  spec-cell:
    ...
    textColor: "{colors.rewards-green}"
