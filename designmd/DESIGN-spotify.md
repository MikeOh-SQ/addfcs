...
version: alpha
name: Spotify
description: A dark immersive audio interface built on layered charcoal surfaces, Spotify green accents, compact utility typography, and pill-and-circle controls designed for touch-first media browsing.
